...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type = str, default = "config/protocols/4-step.yaml", required = True)
    parser.add_argument('--ckpt', type = str, default = "/exp/oxford_mink/models/final_ckpt.pth", required = True)

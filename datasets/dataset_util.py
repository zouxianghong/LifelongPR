...
def make_dataset(pickle_file):
    ...
    dataset = OxfordDataset(configs.data.dataset_folder, pickle_file, transform=train_transform,
...
def make_collate_fn(dataset: OxfordDataset, mink_quantization_size=None):
    ...
    def collate_fn(data_list):
        ...
        if configs.model.name == 'PointNetVlad' or configs.model.name == 'PatchAugNet':
